...
function contactOpen() {
  ...
  function closeForm() {
      ...
      $(closeArea).removeClass('footer-slide__close-area--active')
  ...
  function openForm() {
      ...
      $(closeArea).addClass('footer-slide__close-area--active')
      setTimeout(function () {
       $(pageTransform).removeClass('page-fixed')
      }, 500);
  }
...
function policyOpen() {
  var buttonOpen = $('p.form-cwu__confidential'),
...
function contactsOpen() {
  var buttonOpen = $('.links__navigation-contacts'),
