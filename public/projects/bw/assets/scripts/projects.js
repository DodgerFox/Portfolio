...
$( function() {
  ...
  var filterAttrTrue = $('.filters button.active').attr('data-value');
  console.log(filterAttrTrue)
  console.log(checkboxesAll)
  // bind filter button click
  var $checkboxes = $('.projects__tags-items input');
  var checkboxesAll = [];
  $checkboxes.each(function (i, elem) {
    var checkValue = $(elem).attr('value');
    checkboxesAll.push(checkValue)
  })
...
$grid.isotope({
  ...
  function tagsTooImportant() {
    ...
    $(tagItem).click(function () {
      ...
      var ckickedElem = $(this);

      var clickedElemVal = $(ckickedElem).attr('tag-value');

      var tagFilterElem = $('#checkbox-' + clickedElemVal.slice(1));

          
      console.log(tagFilterElem)
      console.log(clickedElemVal)


      $(tagFilterElem).prop("checked", true);
      var tagFilter = '.landings' + clickedElemVal + ', ' + '.sites' + clickedElemVal + ', ' + '.services' + clickedElemVal;
